...
namespace UserManager\UserProfileBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use UserManager\UserProfileBundle\Entity\UserProfile;
use UserManager\UserProfileBundle\Form\UserProfileType;
...
class UserProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UserManagerUserProfileBundle:UserProfile')->findAll();

        return $this->render('UserManagerUserProfileBundle:UserProfile:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UserManagerUserProfileBundle:UserProfile:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UserManagerUserProfileBundle:UserProfile')->find($id);
        ...
        return $this->render('UserManagerUserProfileBundle:UserProfile:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UserManagerUserProfileBundle:UserProfile:edit.html.twig', array(
            'entity'      => $entity,
